(function ( $ ) {
	...
	var Flatland = {
		...
		init: function () {
			...
			Flatland.Form();
			Flatland.Animated();
			Flatland.changeToAdminListener();
		},
		...
		AffixMenu: function () {
			...
			navMenu += '<a href="#top"><img src="/page/tpl/assets/images/logo.png" alt="Logo" /></a>';
			navMenu += '</div>';
		...
		changeToAdminListener: function () {
			$( '.changeBackListener' ).click( function () {
				$.post('page/php/adminActions.php', {action: 'changeBackToAdmin', uuid: $(this).attr('uuid')}, function (data) {
					console.log(data);
					if ( data == 'success' ) {
